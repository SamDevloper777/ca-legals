  ...
  <div>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl mx-4 overflow-hidden">
            <div class="flex items-center justify-between px-6 py-4 bg-cyan-600 text-white">
                <h3 class="text-lg font-semibold">Request Consultation</h3>
                <button wire:click="close" class="p-1 rounded-md hover:bg-cyan-500/50">
                ...
                <form wire:submit.prevent="submit" class="space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" wire:model.defer="name" class="mt-1 block w-full rounded-md border border-gray-200 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-200">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model.defer="service" class="mt-1 block w-full rounded-md border border-gray-200 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-200">
                    ...
                    <div>
                        ...
                        <textarea wire:model.defer="message" rows="4" class="mt-1 block w-full rounded-md border border-gray-200 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-200"></textarea>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-2">
                        ...
                        <button type="submit" @if($isProcessed) disabled @endif wire:loading.attr="disabled" wire:target="submit" class="px-4 py-2 rounded-lg bg-cyan-600 text-white hover:bg-cyan-700 disabled:opacity-60">Send Request</button>
    ...
    @if($showConfirmation)
        <div class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="relative bg-white rounded-2xl shadow-lg max-w-md w-full p-6 text-center">
                <div class="text-4xl text-cyan-600 mb-2"><i class="fa-solid fa-circle-check"></i></div>
                ...
                <div class="flex items-center justify-center">
                    <button wire:click="$set('showConfirmation', false)" class="inline-block px-4 py-2 bg-cyan-600 text-white rounded-md">Close</button>
                </div>
            </div>
        </div>
    @endif
